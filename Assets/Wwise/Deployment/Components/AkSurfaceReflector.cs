...
#endif
{
	...
	[UnityEngine.Tooltip("The occlusion value per submesh. The occlusion value is a control value used to adjust sound parameters. Typically, a value of 1.0 represents fully occluded, and a value of 0.0 indicates that sound can be transmitted through the geometry. Default value : 1.0.")]
	[UnityEngine.Range(0, 1)]
	/// The occlusion value per submesh. The occlusion value is a control value used to adjust sound parameters. Typically, a value of 1.0 represents fully occluded, and a value of 0.0 indicates that sound can be transmitted through the geometry. Default value : 1.0.
	public float[] OcclusionValues = new[] { 1.0f };
	...
	private class Editor : UnityEditor.Editor
	{
		...
		private UnityEditor.SerializedProperty OcclusionValues;
		...
		public override void OnInspectorGUI()
		{
			...
			UnityEditor.EditorGUILayout.PropertyField(OcclusionValues, true);
			CheckArraySize(m_AkSurfaceReflector, m_AkSurfaceReflector.OcclusionValues.Length, "occlusion values");
