...
namespace UnityEngine.Rendering.PostProcessing
{
    ...
    internal sealed class DepthOfFieldRenderer : PostProcessEffectRenderer<DepthOfField>
    {
        ...
        public override void Render(PostProcessRenderContext context)
        {
            ...
            var sheet = context.propertySheets.Get(Shader.Find("Aetheria/PostProcessing/FogBlur"));
        ...
        static readonly int DepthOfFieldTemp                = Shader.PropertyToID("_DepthOfFieldTemp");
        static readonly int DepthOfFieldTex                 = Shader.PropertyToID("_DepthOfFieldTex");
        static readonly int Distance                        = Shader.PropertyToID("_Distance");
        static readonly int LensCoeff                       = Shader.PropertyToID("_LensCoeff");
        static readonly int MaxCoC                          = Shader.PropertyToID("_MaxCoC");
        static readonly int RcpMaxCoC                       = Shader.PropertyToID("_RcpMaxCoC");
        static readonly int RcpAspect                       = Shader.PropertyToID("_RcpAspect");
        static readonly int CoCTex                          = Shader.PropertyToID("_CoCTex");
        static readonly int TaaParams                       = Shader.PropertyToID("_TaaParams");
    }
}
