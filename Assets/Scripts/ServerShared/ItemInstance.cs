...
{
    [JsonProperty("quality")] [Key(2)]
    public float Quality;

    [JsonProperty("ingredients")] [Key(3)]
    public List<ItemInstance> Ingredients = new List<ItemInstance>();
}
