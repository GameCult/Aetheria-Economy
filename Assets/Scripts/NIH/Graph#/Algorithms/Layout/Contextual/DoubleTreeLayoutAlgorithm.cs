...
namespace GraphSharp.Algorithms.Layout.Contextual
{
        ...
        where TGraph : IBidirectionalGraph<TVertex, TEdge>
    {
        ...
        readonly IDictionary<TVertex, float2> vertexSizes;
        ...
        public DoubleTreeLayoutAlgorithm( TGraph visitedGraph, IDictionary<TVertex, float2> vertexPositions, IDictionary<TVertex, float2> vertexSizes, DoubleTreeLayoutParameters oldParameters, TVertex selectedVertex )
            : base( visitedGraph, vertexPositions, oldParameters )
        {
            root = selectedVertex;
            this.vertexSizes = ( vertexSizes ?? new Dictionary<TVertex, float2>() );
        }
