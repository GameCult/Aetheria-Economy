...
namespace GraphSharp.Algorithms.Layout.Compound.FDP
{
        ...
        where TGraph : IBidirectionalGraph<TVertex, TEdge>
    {
        ...
        /// the compound vertices.</param>
        private void Init(IDictionary<TVertex, float2> vertexSizes, /*IDictionary<TVertex, Thickness> vertexBorders, */IDictionary<TVertex, CompoundVertexInnerLayoutType> layoutTypes)
        {
        ...
        private void InitGravitationMagnitude()
        {
            ...
            if (_levels[0].Count > 0)
                _gravityForceMagnitude = min(sumWidth, sumHeight) / _levels[0].Count;
        }
        ...
        private void InitSimpleVertices(IDictionary<TVertex, float2> vertexSizes)
        {
