...
namespace GraphSharp.Algorithms.Layout.Simple.FDP
{
    ...
    public abstract class FRLayoutParametersBase : LayoutParametersBase
    {
        ...
        internal float _attractionMultiplier = 1.2f;
        internal float _repulsiveMultiplier = 0.6f;
        internal int _iterationLimit = 200;
        internal float _lambda = 0.95f;
		...
		{
			ConstantOfRepulsion = pow( K * _repulsiveMultiplier, 2 );
		...
		/// </summary>
		public float ConstantOfAttraction { get; private set; }
		...
		/// </summary>
		public float ConstantOfRepulsion { get; private set; }
