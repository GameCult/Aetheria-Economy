...
namespace GraphSharp.Algorithms.Layout.Simple.Hierarchical
{
		...
		where TGraph : IVertexAndEdgeListGraph<TVertex, TEdge>
	{
		private class VertexLayer : List<SugiVertex>
		{
			...
			/// </summary>
			public float Height { get { return ComputeHeight(); } }
			...
			private static float ComputeBaryCenter( SugiVertex vertex, IEnumerable<SugiEdge> edges, bool byRealPosition )
			{
				float baryCenter = 0;
				int number = 0;
