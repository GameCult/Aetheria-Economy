...
namespace Microsoft.Msagl.Core.Geometry {
    ...
    public struct Point : IComparable<Point> {
        ...
        public static implicit operator Point(float2 v)     { return new Point(v.x, v.y); }
        public static implicit operator float2(Point v)     { return new float2((float) v.X, (float) v.Y); }
        
        public static implicit operator Point(Vector2 v)     { return new Point(v.x, v.y); }
        public static implicit operator Vector2(Point v)     { return new Vector2((float) v.X, (float) v.Y); }
    }
}
